...
class ServiceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $rows = [
            ...
            ['name' => 'GitHub Teams',     'url' => 'github.com',           'category' => 'Инструменты',  'unit_id' => 'swiftpunk',    'cost' => 8.00,   'currency' => 'USD', 'billing' => 'monthly', 'next_payment' => '2025-05-10', 'status' => 'active'],
            ...
            ['name' => 'Notion',           'url' => 'notion.so',            'category' => 'Инструменты',  'unit_id' => 'swiftpunk',    'cost' => 16.00,  'currency' => 'USD', 'billing' => 'monthly', 'next_payment' => '2025-05-03', 'status' => 'active'],
            ['name' => 'Google Workspace', 'url' => 'workspace.google.com', 'category' => 'Коммуникации', 'unit_id' => 'swiftpunk',    'cost' => 72.00,  'currency' => 'USD', 'billing' => 'monthly', 'next_payment' => '2025-05-20', 'status' => 'active'],
            ...
            ['name' => '1Password',        'url' => '1password.com',        'category' => 'Безопасность', 'unit_id' => 'swiftpunk',    'cost' => 19.95,  'currency' => 'USD', 'billing' => 'monthly', 'next_payment' => '2025-05-18', 'status' => 'active'],
            ['name' => 'Slack',            'url' => 'slack.com',            'category' => 'Коммуникации', 'unit_id' => 'swiftpunk',    'cost' => 0.00,   'currency' => 'USD', 'billing' => 'monthly', 'next_payment' => '2025-05-30', 'status' => 'trial'],
            ...
            ['name' => 'Namecheap',        'url' => 'namecheap.com',        'category' => 'Хостинг',      'unit_id' => 'swiftpunk',    'cost' => 120.00, 'currency' => 'USD', 'billing' => 'yearly',  'next_payment' => '2025-11-01', 'status' => 'active'],
        ];
