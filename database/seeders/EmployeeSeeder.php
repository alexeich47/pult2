...
class EmployeeSeeder extends Seeder
{
    ...
    {
        $rows = [
            ['name' => 'Алексей Шастин',  'position' => 'CEO',               'unit_id' => 'swiftpunk',  'department' => 'Руководство', 'email' => 'a.shastin@swiftpunk.com', 'telegram' => '@alexeich47', 'status' => 'active'],
            ['name' => null,              'position' => 'CFO',               'unit_id' => 'swiftpunk',  'department' => 'Финансы',     'email' => null,                      'telegram' => null,          'status' => 'vacancy'],
            ['name' => 'Елена Голубева',  'position' => 'COO',               'unit_id' => 'swiftpunk',  'department' => 'Операции',    'email' => 'e.golubeva@swiftpunk.com', 'telegram' => '@golubelena', 'status' => 'active'],
            ...
            ['name' => null,              'position' => 'CTO',               'unit_id' => 'swiftpunk',  'department' => 'Технологии',  'email' => null,                      'telegram' => null,          'status' => 'vacancy'],
